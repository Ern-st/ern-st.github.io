...
This was the first time that I've been working with filesystems, so I needed to read up a bit before I could get anywhere with this challenge. I found a [pretty good primer on the subject](https://trailofbits.github.io/ctf/forensics/) that got me started on the right path.
