...
Fixing that mistake, and running the script again gave me all the files… with the proper content this time :+1: quickly thrawling though the files I found the flag superimposed in an image file.
